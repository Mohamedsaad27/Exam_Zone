     ...
     $.ajax({
      ...
      success : function(data){
        if(data.res == "success")
        {
          ...
          refreshDiv();
        }else if (data.res == "cannotDelete")
        {
          Swal.fire(
            "You Cann't Delete This Course",
            'There is some students using this course',
            'error'
          )
        }
      },
...
// Delete Examinee
$(document).on("click", "#deleteExaminee", function(e){
  e.preventDefault();
  var id = $(this).data("id");
  // alert(id);
  $.ajax({
    type : "post",
    url : "query/deleteExamineeExe.php",
    dataType : "json",  
    data : {id:id},
    cache : false,
    success : function(data){
      if(data.res == "success")
      {
        Swal.fire(
          'Success',
          'Selected Examinee successfully deleted',
          'success'
          )
          refreshDiv();
      }else if (data.res == "cannotDelete")
      {
        Swal.fire(
          "You Cann't Delete This Student",
          'This student is already registered in some courses',
          'error'
        )
      }
    },
...
// Block Examinee
$(document).on("click", "#blockExaminee", function(e){
  e.preventDefault();
  var id = $(this).data("id");
   $.ajax({
    type : "post",
    url : "query/blockExaminee.php",
    dataType : "json",  
    data : {id:id},
    cache : false,
    success : function(data){
      if(data.res == "success")
      {
        Swal.fire(
          'Success',
          'Selected Examinee successfully blocked',
          'success'
        )
        refreshDiv();
        window.location.href = window.location.href;
...
// Unblock Examinee
$(document).on("click", "#unblockExaminee", function(e){
  e.preventDefault();
  var id = $(this).data("id");
   $.ajax({
    type : "post",
    url : "query/unblockExaminee.php",
    dataType : "json",  
    data : {id:id},
    cache : false,
    success : function(data){
      if(data.res == "success")
      {
        Swal.fire(
          'Success',
          'Selected Examinee successfully unblocked',
          'success'
        )
        refreshDiv();
        window.location.href = window.location.href;
...
$(document).on("submit","#manageCoursesFrm" , function(){
  var formData = new FormData(this);
     if(data.res == "success")
     {
        Swal.fire(
            'Success',
            ' <br>has been successfully updated!',
            'success'
          )
          refreshDiv();
          window.location.href = window.location.href;
...
// Publish Exam
$(document).on("click", "#publishExam", function(e){
  e.preventDefault();
  var id = $(this).data("id");
   $.ajax({
    type : "post",
    url : "query/publishExam.php",
    dataType : "json",  
    data : {id:id},
    cache : false,
    success : function(data){
      if(data.res == "success")
      {
        Swal.fire(
          'Success',
          'Selected Exam successfully published',
          'success'
        )
        refreshDiv();
        window.location.href = window.location.href;
...
// UnPublish Exam
$(document).on("click", "#unpublishExam", function(e){
  e.preventDefault();
  var id = $(this).data("id");
   $.ajax({
    type : "post",
    url : "query/unPublishExam.php",
    dataType : "json",  
    data : {id:id},
    cache : false,
    success : function(data){
      if(data.res == "success")
      {
        Swal.fire(
          'Success',
          'Selected Exam successfully unpublished',
          'success'
        )
        refreshDiv();
        window.location.href = window.location.href;
...
//   e.preventDefault();
//   var id = $("input[name='id']").val(); // Get the value of the 'id' input field
//   setTimeout(function() {
//     window.location.href = "sendMailRegistration.php?id=" + id;
