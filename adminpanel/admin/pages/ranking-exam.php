<div class="app-main__outer">
  <div class="app-main__inner">
    ...
    if ($exam_id != "") {
      ...
      //  $selExmne = $conn->query("SELECT * FROM examinee_tbl et  WHERE exmne_cours='$exam_course'  ");
      $selExmne = $conn->query("SELECT * FROM examinee_course_tbl WHERE cou_id='$exam_course'");
        ...
        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
          <tbody>
            ...
            while ($selExmneRow = $selExmne->fetch(PDO::FETCH_ASSOC)) { ?>
              <?php
              $exmneId = $selExmneRow['examinee_id'];
              ...
              $selExmneee = $conn->query("SELECT * FROM examinee_tbl WHERE exmne_id='$exmneId' ")->fetch(PDO::FETCH_ASSOC);
              ...
              ?>">
                <td>
                  ...
                  <?php echo $selExmneee['exmne_fullname']; ?>
                </td>
