                                ...
                                while ($selExamRow = $selExam->fetch(PDO::FETCH_ASSOC)) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <?php if ($selExamRow['published'] == 0) { ?>
                                                <button type="button" id="publishExam" data-id='<?php echo $selExamRow['ex_id']; ?>'
                                                    class="btn btn-success btn-sm">Publish</button>
                                            <?php } else { ?>
                                                <button type="button" id="unpublishExam"
                                                    data-id='<?php echo $selExamRow['ex_id']; ?>'
                                                    class="btn btn-warning btn-sm">UnPublish</button>
                                                <a href="query/noticeEmail.php?id=<?php echo $selExamRow['ex_id']; ?>" type="button"
                                                    class="btn btn-secondary btn-sm">Send Email</a>
                                            <?php } ?>
